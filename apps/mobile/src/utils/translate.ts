...
const LIBRETRANSLATE_API =
  process.env.EXPO_PUBLIC_LIBRETRANSLATE_API || "https://libretranslate.com";
const LIBRETRANSLATE_KEY = process.env.EXPO_PUBLIC_LIBRETRANSLATE_KEY || "";
