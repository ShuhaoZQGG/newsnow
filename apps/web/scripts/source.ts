...
import { genSources } from "@newsnow/shared/pre-sources"
...
try {
  ...
  writeFileSync(join(projectDir, "packages/shared/pinyin.json"), JSON.stringify(pinyinMap, undefined, 2))
...
try {
  writeFileSync(join(projectDir, "packages/shared/sources.json"), JSON.stringify(Object.fromEntries(Object.entries(sources)), undefined, 2))
